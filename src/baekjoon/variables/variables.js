import Base from '../../common/variables/variables';
...
*/
export default class Variables extends Base {
  ...
  RESULT_MESSAGE = {
    [this.RESULT_CATEGORY.RESULT_PENDING]: '기다리는 중',
    [this.RESULT_CATEGORY.RESULT_PENDING_REJUDGE]: '재채점을 기다리는 중',
    [this.RESULT_CATEGORY.RESULT_NO_JUDGE]: '채점하지 않음',
    [this.RESULT_CATEGORY.RESULT_PREPARE_FOR_JUDGE]: '채점 준비 중',
    [this.RESULT_CATEGORY.RESULT_JUDGING]: '채점 중',
    [this.RESULT_CATEGORY.RESULT_ACCEPTED]: '맞았습니다!!',
    [this.RESULT_CATEGORY.RESULT_PARTIALLY_ACCEPTED]: '맞았습니다!!',
    [this.RESULT_CATEGORY.RESULT_PRESENTATION_ERROR]:
      '출력 형식이 잘못되었습니다',
    [this.RESULT_CATEGORY.RESULT_WRONG_ANSWER]: '틀렸습니다',
    [this.this.RESULT_CATEGORY.RESULT_ACCEPTED_NOT_CORRECT]: '!맞았습니다',
    [this.RESULT_CATEGORY.RESULT_TIME_LIMIT_EXCEEDED]: '시간 초과',
    [this.RESULT_CATEGORY.RESULT_MEMORY_LIMIT_EXCEEDED]: '메모리 초과',
    [this.RESULT_CATEGORY.RESULT_OUTPUT_LIMIT_EXCEEDED]: '출력 초과',
    [this.RESULT_CATEGORY.RESULT_RUNTIME_ERROR]: '런타임 에러',
  };
